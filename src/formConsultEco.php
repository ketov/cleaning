...
if ($email !== false) {
    ...
    mail("2087844@bk.ru, AC2087844@gmail.com, ayvazov@i-market.ru, ketov1992@list.ru", iconv("utf-8", "windows-1251", "АКЦИЯ2018.ЭКО.ПолучитьКонсультацию"), $message, $headers);
    header("Success: ");
}
