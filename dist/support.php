...
<html>
  ...
  <body><input type="hidden" value="<?php if($_REQUEST["utm_content"]=="5837974965") $title="Клининговые услуги в&nbsp;Волоколамске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001444") $title="Клининговые услуги в&nbsp;Волоколамске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153977") $title="Клининговые услуги в&nbsp;Волоколамске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5837919740") $title="Клининговые услуги в&nbsp;Звенигороде от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001440") $title="Клининговые услуги в&nbsp;Звенигороде от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153973") $title="Клининговые услуги в&nbsp;Звенигороде от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5837937957") $title="Клининговые услуги в&nbsp;Истре от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001441") $title="Клининговые услуги в&nbsp;Истре от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153974") $title="Клининговые услуги в&nbsp;Истре от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5837816362") $title="Клининговые услуги в&nbsp;Красногорске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001437") $title="Клининговые услуги в&nbsp;Красногорске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153970") $title="Клининговые услуги в&nbsp;Красногорске от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5837966056") $title="Клининговые услуги в&nbsp;Кубинке &nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001442") $title="Клининговые услуги в&nbsp;Кубинке от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153975") $title="Клининговые услуги в&nbsp;Кубинке от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838140666") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153980") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838140665") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153981") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838118525") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838133153") $title="Клининговые услуги в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5837904236") $title="Клининговые услуги &nbsp;Одинцово от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001439") $title="Клининговые услуги в&nbsp;Одинцово от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153972") $title="Клининговые услуги в&nbsp;Одинцово от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5837971397") $title="Клининговые услуги в&nbsp;Рузе от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838001443") $title="Клининговые услуги в&nbsp;Рузе от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838153976") $title="Клининговые услуги в&nbsp;Рузе от&nbsp;3&nbsp;000&nbsp;руб."; if($_REQUEST["utm_content"]=="5838140664") $title="Поддерживающая уборка квартиры в&nbsp;Московской области от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838153979") $title="Поддерживающая уборка квартиры в&nbsp;Московской области от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838107524") $title="Поддерживающая уборка квартиры в&nbsp;Московской области от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5837780561") $title="Уборка квартир и&nbsp;домов в&nbsp;Красногорске от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838001436") $title="Уборка квартир и&nbsp;домов в&nbsp;Красногорске от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838153969") $title="Уборка квартир и&nbsp;домов в&nbsp;Красногорске от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5837865841") $title="Уборка квартир и&nbsp;домов в&nbsp;Одинцово от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838001438") $title="Уборка квартир и&nbsp;домов в&nbsp;Одинцово от&nbsp;3&nbsp;000 руб."; if($_REQUEST["utm_content"]=="5838153971") $title="Уборка квартир и&nbsp;домов в&nbsp;Одинцово от&nbsp;3&nbsp;000 руб."; if(!$title) $title = "Поддерживающая уборка квартир в&nbsp;Московской области от&nbsp;3&nbsp;000 руб." ?>" />
    ...
    <section class="c-form" id="form-header-support">
      ...
      <button id="form-header-support-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-iz-shapki'); return true;">Отправить!</button>
    </section>
    ...
    <section class="c-form" id="form-consult-support">
      ...
      <button id="form-consult-support-button" onclick="yaCounter51970151.reachGoal('knopka-polucit-konsultaciyi-snizu'); return true;">Отправить!</button>
    </section>
    <header>
      <div class="wrapper">
    ...
    <section class="offer parallax-window" style="background: url(assets/img/offer-bg.jpg) no-repeat; background-size: cover;">
      <div class="wrapper"> 
        <!--h1 Поддерживающая уборка квартир и&nbsp;домов в&nbsp;Московской области от&nbsp;3&nbsp;000&nbsp;руб.-->
        ...
        <div class="row-fluid show-grid">
          <div class="span12 form-count__plate">
            <div class="row-fluid show-grid">
              ...
              <div class="span4">
                <button id="form-count-support-button" onclick="yaCounter51970151.reachGoal('knopka-rasschitat-stoimost'); return true;">Рассчитать стоимость</button>
              </div>
            </div>
            <div class="row-fluid show-grid">
                ...
                <div class="tree">
                  ...
                  <div class="layer three">
                    ...
                    <div class="bauble three" id="promocode2018">
                      ...
                      <input id="form-promocode-christmas-hidden" type="hidden" value="Акция2018.Поддерживающая.Ёлка">
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Подарочный сертификат" data-form="Акция2018.Поддерживающая.Слайдер.Подарочный сертификат">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Приведи друга" data-form="Акция2018.Поддерживающая.Слайдер.Приведи друга">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.Поддерживающая.Слайдер.Соседи">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Постоянный клиент" data-form="Акция2018.Поддерживающая.Слайдер.Постоянный клиент">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.Поддерживающая.Слайдер.Для детск.">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="wrapper">
        ...
        <div class="row-fluid show-grid">
          <div class="span6 offset3"> 
            ...
            <button id="form-support-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-zayavka-na-uborku'); return true;">Отправить</button>
          </div>
        </div>
      </div>
    </section>
