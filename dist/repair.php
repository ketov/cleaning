...
<html>
  <head>
    <title>Академия чистоты | Уборка после ремонта</title>
  ...
  <body>
    ...
    <section class="c-form" id="form-header-repair">
      ...
      <input id="input-form-header-repair-phone" type="text" placeholder="Номер телефона">
      <input id="input-form-header-repair-campaign" type="hidden" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
      <input id="input-form-header-repair-term" type="hidden" value="<?php echo isset($_GET['utm_term']) ? $_GET['utm_term'] : '' ;?>" />
      <div class="error-text" id="input-form-header-repair-phone-error"></div>
      <div class="success-text" id="input-form-header-repair-success"></div>
      <button id="form-header-repair-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-iz-shapki'); return true;">Отправить!</button>
    </section>
    ...
    <section class="c-form" id="form-consult-repair">
      <div class="close-form">
        <div class="close-form__line close-form__line--1"></div>
        <div class="close-form__line close-form__line--2"></div>
      </div>
      ...
      <input id="input-form-consult-repair-phone" type="text" placeholder="Номер телефона">
      <input id="input-form-consult-repair-campaign" type="hidden" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
      <input id="input-form-consult-repair-term" type="hidden" value="<?php echo isset($_GET['utm_term']) ? $_GET['utm_term'] : '' ;?>" />
      <div class="error-text" id="input-form-consult-repair-phone-error"></div>
      <div class="success-text" id="input-form-consult-repair-success"></div>
      <button id="form-consult-repair-button" onclick="yaCounter51970151.reachGoal('knopka-polucit-konsultaciyi-snizu'); return true;">Отправить!</button>
    </section>
    <header>
      ...
      <div class="wrapper">
        ...
        <button class="header__order" id="header-repair-button">Оформить заявку</button><a class="phone" href="tel:+74952087844"> 
    ...
    <section class="offer parallax-window" data-parallax="scroll" data-image-src="assets/img/offer-bg.jpg">
      <div class="wrapper">
        <h1>Уборка после ремонта в&nbsp;Московской области от 6 000 руб.</h1>
        <p class="comment">Работаем по направлениям: Волоколамское, Ильинское, Минское, Новорижское, Рублёвское шоссе, район Истры.</p>
        <div class="tabs">
          <div class="tabs__tab tabs__tab--1 active" data-show="range-repair" data-hide="range-repair-home">Квартиры</div>
          <div class="tabs__tab tabs__tab--2" data-show="range-repair-home" data-hide="range-repair">Дома</div>
          <div class="clear"></div>
        </div>
        <div class="row-fluid show-grid" id="range-repair">
        ...
        <div class="row-fluid show-grid" id="range-repair-home">
          <div class="span6 offset2">
            <div class="span9"> 
      ...
      <div class="wrapper">
        <div class="row-fluid show-grid">
          <div class="span12 form-count__plate">
            <div class="row-fluid show-grid">
              <div class="span4">
                <input id="input-form-count-repair-name" type="text" placeholder="Ваше имя">
              </div>
              <div class="span4">
                <input id="input-form-count-repair-phone" type="text" placeholder="Телефон">
                <input id="input-form-count-repair-campaign" type="hidden" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
                <input id="input-form-count-repair-term" type="hidden" value="<?php echo isset($_GET['utm_term']) ? $_GET['utm_term'] : '' ;?>" />    
              </div>
              <div class="span4">
                <button id="form-count-repair-button" onclick="yaCounter51970151.reachGoal('knopka-rasschitat-stoimost'); return true;">Рассчитать стоимость</button>
              </div>
            </div>
            <div class="row-fluid show-grid">
              <div class="success-text" id="input-form-count-repair-success"></div>
              <div class="error-text" id="input-form-count-repair-phone-error"></div>
                ...
                <div class="tree">
                  ...
                  <div class="layer three">
                    ...
                    <div class="bauble three" id="promocode2018">
                      ...
                      <input id="form-promocode-christmas-hidden" type="hidden" value="Акция2018.После ремонта.Ёлка">
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Подарочный сертификат" data-form="Акция2018.После ремонта.Слайдер.Подарочный сертификат">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Приведи друга" data-form="Акция2018.После ремонта.Слайдер.Приведи друга">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.После ремонта.Слайдер.Соседи">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Постоянный клиент" data-form="Акция2018.После ремонта.Слайдер.Постоянный клиент">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.После ремонта.Слайдер.Для детск.">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section class="works">
      <div class="wrapper">
        <h2>Как мы делаем уборку после ремонта</h2>
        <div class="row-fluid show-grid">
          <div class="span6">
            <h3>Комнаты и коридоры</h3>
            <ul>
              <li>Убираем мусор, заменяем одноразовые пакеты, моем корзину изнутри и снаружи;</li>
              <li>Убираем пыль с поверхности стен и потолков;</li>
              <li>Моем карнизы (в эту услугу не входит стирка штор);</li>
              <li>Обработка климатической техники, очищение внутренних фильтров устройства;</li>
              <li>Моем все светильники, используемые в доме (кроме хрустальных изделий);</li>
              <li>Уборка корпусной мебели: обрабатывается как внутренняя, так и внешняя поверхность предметов при условии отсутствия в них вещей;</li>
              <li>Обработка зеркал и различных стеклянных покрытий и элементов декора (кроме окон) с помощью специализированных средств (на всю высоту);</li>
              <li>Очищаем аксессуары и предметы интерьера от пыли и различных загрязнений;</li>
              <li>Очищаем бытовую технику от скопившейся пыли;</li>
              <li>Уборка пыли на подоконнике и последующая мойка коммуникаций;</li>
              <li>Уборка пылесосом внутренней и внешней поверхности мягкой мебели;</li>
              <li>Обрабатываем кожаные предметы мебели профессиональными чистящими составами;</li>
              <li>Меняем спальный комплект;</li>
              <li>Сухая и влажна уборка дверных блоков, а также используемой фурнитуры;</li>
              <li>Устраняем разного рода строительные загрязнения;</li>
              <li>Эко-уборка с помощью парогенератора (для труднодоступных мест);</li>
              <li>Мытьё плинтусов и уборка напольных покрытий любого типа.</li>
            </ul>
          </div>
          <div class="span6">
            <h3>Ванная комната</h3>
            <ul>
              <li>Обрабатываем потолок;</li>
              <li>Влажная уборка керамической плитки на всю имеющуюся высоту помещения;</li>
              <li>Чистим ванны, джакузи и душевые кабины (учитывается как внешняя, так и внутренняя поверхность);</li>
              <li>Устраняем загрязнения с поверхности бытовых приборов;</li>
              <li>Очищаем раковины, унитазы, биде и смесители с последующей дезинфекцией;</li>
              <li>Очищаем межплиточные швы;</li>
              <li>Убираем труднодоступные зоны помещения с использованием парогенератора.</li>
            </ul>
          </div>
        </div>
        <div class="row-fluid show-grid">
          <div class="span6">
            <h3>Кухня</h3>
            <ul>
              <li>Влажная уборка фасадов кухонной мебели с обязательным удалением жирных следов;</li>
              <li>Моем внутренние части ящиков и шкафов;</li>
              <li>Моем грязную посуду, стоящую в раковине;</li>
              <li>Обработка «фартука», удаление различных загрязнений;</li>
              <li>Влажная уборка вытяжки (с учетом внутренней и внешней поверхности) со снятием используемых фильтров;</li>
              <li>Очищаем плиту (внутри и снаружи);</li>
              <li>Комплексная чистка холодильной камеры;</li>
              <li>Удаляем загрязнения с внутренней и внешней части микроволновой печи;</li>
              <li>Тщательно обрабатываем другую кухонную технику;</li>
              <li>Моем и дезинфицируем сантехническое оборудование;</li>
              <li>Устраняем самые сложные загрязнения (включая налёт извести, ржавчину);</li>
              <li>Тщательно обрабатываем труднодоступные места кухни с помощью парогенератора.</li>
            </ul>
          </div>
          <div class="span6">
            <h3>Устранение загрязнений после ремонта</h3>
            <ul>
              <li>Очистку от послестроительной пыли и следов цемента, влажную и сухую уборку стен и потолочных покрытий;</li>
              <li>Устраняем засохший клей и строительный скотч со стёкол, зеркал, предметов мебели;</li>
              <li>Удаление пятен краски и уборка после строительства напольных покрытий, паркета, подоконников;</li>
              <li>Стандартные работы по обеспыливанию всех поверхностей в доме (влажная чистка);</li>
              <li>Очищаем от мелких строительных отходов и мусора;</li>
              <li>Дезинфицируем место, отведённое под хранение отходов;</li>
              <li>Влажная и сухая послестроительная уборка корпусной и мягкой мебели, рабочих поверхностей, внешних фасадов и стеновых панелей гарнитуров, дверей холодильники, духовой и микроволновой печи;</li>
              <li>Чистим сантехнику с последующим дезинфицированием;</li>
              <li>Частим душевые кабины и ванны;</li>
              <li>Собираем и выносим мелкий строительный мусор.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="wrapper">
        ...
        <div class="row-fluid show-grid">
          <div class="span3 offset3"> 
            <input id="input-form-repair-name" type="text" placeholder="Ваше имя">
          </div>
          <div class="span3">
            <input id="input-form-repair-phone" type="text" placeholder="Телефон">
          </div>
        </div>
        <div class="row-fluid show-grid">
          <div class="span6 offset3"> 
            <textarea id="input-form-repair-message" placeholder="Сообщение"></textarea>
            <input id="input-form-repair-campaign" type="hidden" value="<?php echo isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : '' ;?>" />
            <input id="input-form-repair-term" type="hidden" value="<?php echo isset($_GET['utm_term']) ? $_GET['utm_term'] : '' ;?>" />
          </div>
        </div>
        <div class="row-fluid show-grid">
          <div class="span6 offset3"> 
            <div class="success-text" id="input-form-repair-success"></div>
            <div class="error-text" id="input-form-repair-phone-error"></div>
            <button id="form-repair-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-zayavka-na-uborku'); return true;">Отправить</button>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="wrapper">
        <div class="row-fluid show-grid">
          <div class="span8 offset2"> 
            ...
            <button id="contacts-repair-button">Получить консультацию</button>
          </div>
        </div>
      </div>
    </section>
