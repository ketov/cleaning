...
},function(module,exports,__webpack_require__){__webpack_require__(3)(__webpack_require__(10))},function(module,exports){module.exports='"use strict";\n\n/*!\n * jQuery UI Touch Punch 0.2.3\n *\n * Copyright 2011–2014, Dave Furfero\n * Dual licensed under the MIT or GPL Version 2 licenses.\n *\n * Depends:\n *  jquery.ui.widget.js\n *  jquery.ui.mouse.js\n */\n!function (a) {\n  function f(a, b) {\n    if (!(a.originalEvent.touches.length > 1)) {\n      a.preventDefault();var c = a.originalEvent.changedTouches[0],\n          d = document.createEvent("MouseEvents");d.initMouseEvent(b, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1, !1, !1, !1, 0, null), a.target.dispatchEvent(d);\n    }\n  }if (a.support.touch = "ontouchend" in document, a.support.touch) {\n    var e,\n        b = a.ui.mouse.prototype,\n        c = b._mouseInit,\n        d = b._mouseDestroy;b._touchStart = function (a) {\n      var b = this;!e && b._mouseCapture(a.originalEvent.changedTouches[0]) && (e = !0, b._touchMoved = !1, f(a, "mouseover"), f(a, "mousemove"), f(a, "mousedown"));\n    }, b._touchMove = function (a) {\n      e && (this._touchMoved = !0, f(a, "mousemove"));\n    }, b._touchEnd = function (a) {\n      e && (f(a, "mouseup"), f(a, "mouseout"), this._touchMoved || f(a, "click"), e = !1);\n    }, b._mouseInit = function () {\n      var b = this;b.element.bind({ touchstart: a.proxy(b, "_touchStart"), touchmove: a.proxy(b, "_touchMove"), touchend: a.proxy(b, "_touchEnd") }), c.call(b);\n    }, b._mouseDestroy = function () {\n      var b = this;b.element.unbind({ touchstart: a.proxy(b, "_touchStart"), touchmove: a.proxy(b, "_touchMove"), touchend: a.proxy(b, "_touchEnd") }), d.call(b);\n    };\n  }\n}(jQuery);'},function(module,exports){"use strict";function scrollTo(element,anchor){$(element).click(function(){var destination=$(anchor).offset().top;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},500),!1})}$(document).ready(function(){$(".close-form").on("click",function(){$(this).parent(".c-form").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)}),scrollTo(".header__works",".works"),scrollTo(".header__form",".form"),scrollTo(".header__map-container",".contacts")})},function(module,exports){"use strict";$(document).ready(function(){$("#contacts-general-button").on("click",function(){var top=$(window).scrollTop()+100;$("#form-consult-general").css({top:top}),$(".black-bg").stop(!0,!0).fadeIn(300),setTimeout(function(){$("#form-consult-general").stop(!0,!0).fadeIn(300)},350)})})},function(module,exports){"use strict";$(document).ready(function(){function scrollTo(element,anchor){$(element).click(function(){var destination=$(anchor).offset().top;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},500),!1})}scrollTo(".header__video",".video"),scrollTo(".header__courses",".courses"),scrollTo(".header__for",".for"),scrollTo(".header__economy",".economy"),scrollTo(".header__reviews",".reviews"),scrollTo(".header__author",".author"),scrollTo(".header__form",".form"),scrollTo(".offer__button",".economy"),scrollTo(".courses__button",".form"),$("#form-button").click(function(){$("#input__email").removeClass("error");var req=new XMLHttpRequest,formData=new FormData,name=$("#input-name").val().trim(),email=$("#input-email").val().trim(),course=$("#input-course").val().trim();formData.append("name",name),formData.append("email",email),formData.append("course",course),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#form__success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-email").removeClass("error"),$("#form__error").html(""),void $("#input-name, #input-email, #input-course").val("");$("#input-email").addClass("error"),$("#form__error").html("Введите правильный номер телефона: +7 xxx xxx xx xx или эл. почту"),$("#form__success").text("")}},req.open("POST","form.php",!0),req.send(formData)})})},function(module,exports){"use strict";$(document).ready(function(){$("#header-general-button").on("click",function(){var top=$(window).scrollTop()+100;$("#form-header-general").css({top:top}),$(".black-bg").stop(!0,!0).fadeIn(300),setTimeout(function(){$("#form-header-general").stop(!0,!0).fadeIn(300)},350)}),$("#header-support-button").on("click",function(){var top=$(window).scrollTop()+100;$("#form-header-support").css({top:top}),$(".black-bg").stop(!0,!0).fadeIn(300),setTimeout(function(){$("#form-header-support").stop(!0,!0).fadeIn(300)},350)}),$("#header-repair-button").on("click",function(){var top=$(window).scrollTop()+100;$("#form-header-repair").css({top:top}),$(".black-bg").stop(!0,!0).fadeIn(300),setTimeout(function(){$("#form-header-repair").stop(!0,!0).fadeIn(300)},350)})})},function(module,exports){"use strict";$(document).ready(function(){function init(){var mapOptions={zoom:9,center:new google.maps.LatLng(55.755826,37.6172999),scrollwheel:!1},mapElement=document.getElementById("map");new google.maps.Map(mapElement,mapOptions)}google.maps.event.addDomListener(window,"load",init)})},function(module,exports){"use strict";$(document).ready(function(){$("#range-general").length>0&&$(function(){$("#slider-range").slider({range:"min",value:100,min:20,max:600,slide:function(event,ui){$("#amount").val(ui.value);var value=Number(ui.value);value<=100&&(value=5e3),value>100&&value<=250&&(value=1e4),value>250&&value<=350&&(value=15e3),value>350&&value<=600&&(value=40*Number(ui.value)),$("#amount2").html(value+"<span> руб.</span>")}}),$("#amount").val($("#slider-range").slider("value")),$("#amount2").html("5000<span> руб.</span>")}),$("#form-header-general-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,email=$("#input-form-header-general-phone").val().trim();formData.append("email",email),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-header-general-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-header-general-phone").removeClass("error"),$("#input-form-header-general-phone-error").html(""),$("#input-form-header-general-phone").val(""),void setTimeout(function(){$("#form-header-general").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)},4e3);$("#input-form-header-general-phone").addClass("error"),$("#input-form-header-general-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-header-general-success").text("")}},req.open("POST","formHeaderGeneral.php",!0),req.send(formData)}),$("#form-count-general-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,name=$("#input-form-count-general-name").val().trim(),phone=$("#input-form-count-general-phone").val().trim();formData.append("name",name),formData.append("phone",phone),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-count-general-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-count-general-phone").removeClass("error"),$("#input-form-count-general-phone-error").html(""),$("#input-form-count-general-phone").val(""),void $("#input-form-count-general-name").val("");$("#input-form-count-general-phone").addClass("error"),$("#input-form-count-general-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-count-general-success").text("")}},req.open("POST","formCountGeneral.php",!0),req.send(formData)}),$("#form-consult-general-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,email=$("#input-form-consult-general-phone").val().trim();formData.append("email",email),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-consult-general-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-consult-general-phone").removeClass("error"),$("#input-form-consult-general-phone-error").html(""),$("#input-form-consult-general-phone").val(""),void setTimeout(function(){$("#form-consult-general").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)},4e3);$("#input-form-consult-general-phone").addClass("error"),$("#input-form-consult-general-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-consult-general-success").text("")}},req.open("POST","formConsultGeneral.php",!0),req.send(formData)})})},function(module,exports){"use strict";$(document).ready(function(){$("#range-support").length>0&&$(function(){$("#slider-range").slider({range:"min",value:100,min:20,max:600,slide:function(event,ui){$("#amount").val(ui.value);var value=Number(ui.value);value<=100&&(value=2500),value>100&&value<=250&&(value=4500),value>250&&value<=350&&(value=6500),value>350&&value<=600&&(value=18*Number(ui.value)),$("#amount2").html(value+"<span> руб.</span>")}}),$("#amount").val($("#slider-range").slider("value")),$("#amount2").html("2500<span> руб.</span>")}),$("#form-header-support-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,email=$("#input-form-header-support-phone").val().trim();formData.append("email",email),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-header-support-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-header-support-phone").removeClass("error"),$("#input-form-header-support-phone-error").html(""),$("#input-form-header-support-phone").val(""),void setTimeout(function(){$("#form-header-support").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)},4e3);$("#input-form-header-support-phone").addClass("error"),$("#input-form-header-support-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-header-support-success").text("")}},req.open("POST","formHeaderSupport.php",!0),req.send(formData)}),$("#form-count-support-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,name=$("#input-form-count-support-name").val().trim(),phone=$("#input-form-count-support-phone").val().trim();formData.append("name",name),formData.append("phone",phone),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-count-support-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-count-support-phone").removeClass("error"),$("#input-form-count-support-phone-error").html(""),$("#input-form-count-support-phone").val(""),void $("#input-form-count-support-name").val("");$("#input-form-count-support-phone").addClass("error"),$("#input-form-count-support-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-count-support-success").text("")}},req.open("POST","formCountSupport.php",!0),req.send(formData)})})},function(module,exports){"use strict";$(document).ready(function(){$("#range-repair").length>0&&$(function(){$("#slider-range").slider({range:"min",value:100,min:20,max:600,slide:function(event,ui){$("#amount").val(ui.value);var value=Number(ui.value);value<=100&&(value=8e3),value>100&&value<=250&&(value=2e4),value>250&&value<=350&&(value=28e3),value>350&&value<=600&&(value=80*Number(ui.value)),$("#amount2").html(value+"<span> руб.</span>")}}),$("#amount").val($("#slider-range").slider("value")),$("#amount2").html("8000<span> руб.</span>")}),$("#form-header-repair-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,email=$("#input-form-header-repair-phone").val().trim();formData.append("email",email),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-header-repair-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-header-repair-phone").removeClass("error"),$("#input-form-header-repair-phone-error").html(""),$("#input-form-header-repair-phone").val(""),void setTimeout(function(){$("#form-header-support").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)},4e3);$("#input-form-header-repair-phone").addClass("error"),$("#input-form-header-repair-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-header-repair-success").text("")}},req.open("POST","formHeaderRepair.php",!0),req.send(formData)}),$("#form-count-repair-button").click(function(){var req=new XMLHttpRequest,formData=new FormData,name=$("#input-form-count-repair-name").val().trim(),phone=$("#input-form-count-repair-phone").val().trim();formData.append("name",name),formData.append("phone",phone),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#input-form-count-repair-success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-form-count-repair-phone").removeClass("error"),$("#input-form-count-repair-phone-error").html(""),$("#input-form-count-repair-phone").val(""),void $("#input-form-count-repair-name").val("");$("#input-form-count-repair-phone").addClass("error"),$("#input-form-count-repair-phone-error").html("Введите правильный номер телефона: +7 xxx xxx xx xx"),$("#input-form-count-repair-success").text("")}},req.open("POST","formCountRepair.php",!0),req.send(formData)})})}]);