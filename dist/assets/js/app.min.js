...
},function(module,exports){"use strict";$(document).ready(function(){$(".close-form").on("click",function(){$("#form-header-general").stop(!0,!0).fadeOut(300),setTimeout(function(){$(".black-bg").stop(!0,!0).fadeOut(300)},350)})}),$(document).ready(function(){$("#hamburger").on("click",function(){var el=$(this),p=el.parent(".in-wrapper");el.hasClass("active")?(p.children("nav").stop(!0,!0).slideUp(250),el.removeClass("active"),$("header").removeClass("active")):(p.children("nav").stop(!0,!0).slideDown(250),el.addClass("active"),$("header").addClass("active"))})})},function(module,exports){"use strict";$(document).ready(function(){function scrollTo(element,anchor){$(element).click(function(){var destination=$(anchor).offset().top;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},500),!1})}scrollTo(".header__video",".video"),scrollTo(".header__courses",".courses"),scrollTo(".header__for",".for"),scrollTo(".header__economy",".economy"),scrollTo(".header__reviews",".reviews"),scrollTo(".header__author",".author"),scrollTo(".header__form",".form"),scrollTo(".offer__button",".economy"),scrollTo(".courses__button",".form"),$("#form-button").click(function(){$("#input__email").removeClass("error");var req=new XMLHttpRequest,formData=new FormData,name=$("#input-name").val().trim(),email=$("#input-email").val().trim(),course=$("#input-course").val().trim();formData.append("name",name),formData.append("email",email),formData.append("course",course),req.onreadystatechange=function(){if(4==req.readyState&&200==req.status){var success=req.getResponseHeader("Success");if(null!=success)return $("#form__success").html("Ваша заявка принята. Менеджер свяжется с вами в течении часа."),$("#input-email").removeClass("error"),$("#form__error").html(""),void $("#input-name, #input-email, #input-course").val("");$("#input-email").addClass("error"),$("#form__error").html("Введите правильный номер телефона: +7 xxx xxx xx xx или эл. почту"),$("#form__success").text("")}},req.open("POST","form.php",!0),req.send(formData)})})},function(module,exports){"use strict";$(document).ready(function(){$(".header__order").on("click",function(){var top=$(window).scrollTop()+40;$("#form-header-general").css({top:top}),$(".black-bg").stop(!0,!0).fadeIn(300),setTimeout(function(){$("#form-header-general").stop(!0,!0).fadeIn(300)},350)})})},function(module,exports){"use strict";$(document).ready(function(){function init(){var mapOptions={zoom:11,center:new google.maps.LatLng(40.67,-73.94),scrollwheel:!1,styles:[{featureType:"all",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"landscape",elementType:"all",stylers:[{visibility:"on"},{color:"#f3f4f4"}]},{featureType:"landscape.man_made",elementType:"geometry",stylers:[{weight:.9},{visibility:"off"}]},{featureType:"poi.park",elementType:"geometry.fill",stylers:[{visibility:"on"},{color:"#83cead"}]},{featureType:"road",elementType:"all",stylers:[{visibility:"on"},{color:"#ffffff"}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"road.highway",elementType:"all",stylers:[{visibility:"on"},{color:"#fee379"}]},{featureType:"road.arterial",elementType:"all",stylers:[{visibility:"on"},{color:"#fee379"}]},{featureType:"water",elementType:"all",stylers:[{visibility:"on"},{color:"#7fc8ed"}]}]},mapElement=document.getElementById("map"),map=new google.maps.Map(mapElement,mapOptions);new google.maps.Marker({position:new google.maps.LatLng(40.67,-73.94),map:map,title:"Snazzy!"})}google.maps.event.addDomListener(window,"load",init)})},function(module,exports){"use strict";$(document).ready(function(){$(function(){$("#slider-range").slider({range:"min",value:20,min:20,max:700,slide:function(event,ui){$("#amount").val(ui.value),$("#amount2").html(ui.value+10)}}),$("#amount").val($("#slider-range").slider("value")),$("#amount2").html($("#slider-range").slider("value")+1)})})}]);