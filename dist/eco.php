...
<html>
  ...
  <body>
    ...
    <section class="c-form" id="form-header-eco">
      ...
      <button id="form-header-eco-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-iz-shapki'); return true;">Отправить!</button>
    </section>
        ...
        <div class="row-fluid show-grid">
          <div class="span12 form-count__plate">
            <div class="row-fluid show-grid">
              ...
              <div class="span4">
                <button id="form-count-eco-button" onclick="yaCounter51970151.reachGoal('knopka-rasschitat-stoimost'); return true;">Рассчитать стоимость</button>
              </div>
            </div>
            <div class="row-fluid show-grid">
                ...
                <div class="tree">
                  ...
                  <div class="layer three">
                    ...
                    <div class="bauble three" id="promocode2018">
                      ...
                      <input id="form-promocode-christmas-hidden" type="hidden" value="Акция2018.ЭКО.Ёлка">
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Подарочный сертификат" data-form="Акция2018.ЭКО.Слайдер.Подарочный сертификат">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Приведи друга" data-form="Акция2018.ЭКО.Слайдер.Приведи друга">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.ЭКО.Слайдер.Соседи">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Постоянный клиент" data-form="Акция2018.ЭКО.Слайдер.Постоянный клиент">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="christmas__slide-button-outer">
                      <div class="christmas__slide-button-container">
                        <div class="christmas__slide-button-border">
                          ...
                          <button class="christmas-button" data-header="Соседи" data-form="Акция2018.ЭКО.Слайдер.Для детск.">Участвовать</button>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="wrapper">
        ...
        <div class="row-fluid show-grid">
          <div class="span6 offset3"> 
            ...
            <button id="form-eco-button" onclick="yaCounter51970151.reachGoal('knopka-otpravit-zayavka-na-uborku'); return true;">Отправить</button>
          </div>
        </div>
      </div>
    </section>
